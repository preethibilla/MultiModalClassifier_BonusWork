...
- - - All the execution and change screenshots have been saved in the screenshot folder and have been pushed to my git repository.
...
- - - 3.Executing the exportTFlite.py file generates the converted_model.tflite file.
