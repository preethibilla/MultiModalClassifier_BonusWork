...
class TFInference:
    ...
    def loadsavedmodel(self, path):
        # "gs://cmpelkk_imagetest/saved_models/my_savedmodel202102")
    ...
    def PILgetonlineimagearray(self,url, img_height, img_width):
        ...
        # (width, height) https://pillow.readthedocs.io/en/stable/reference/Image.html
    ...
    def main(self):
        ...
        model = self.loadsavedmodel(
            '/Users/admin/Documents/Github/MultiModalClassifier/TFClassifier/outputs/fashion')
        ...
        self.inference(model, img_array, class_names)
